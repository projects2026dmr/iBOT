...
export default function GminaPage() {
  const { gminaSlug } = useParams<{ gminaSlug: string }>();
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl md:text-5xl">
              SEO w gminie: {gminaSlug}
            </h1>
            <p className="mt-6 text-lg text-slate-600">
              Strona gminy — treść pojawi się wkrótce.
            </p>
            ...
            <div className="mt-12 rounded-2xl border border-slate-200 bg-slate-50 p-10">
              <p className="text-sm text-slate-500">
                ...
                szczegółowe informacje o usługach SEO w tej gminie.
              </p>
            </div>
