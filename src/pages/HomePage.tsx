    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-indigo-950 to-slate-900 py-16 sm:py-20 md:py-28 lg:py-36">
      ...
      <div className="container relative mx-auto px-4">
        <div className="mx-auto max-w-4xl text-center">
          ...
          {/* Subheadline */}
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-slate-300 sm:mt-6 sm:text-lg md:text-xl">
          ...
          {/* Benefits */}
          <ul className="mx-auto mt-6 flex max-w-xl flex-col gap-2.5 text-left sm:mt-8 sm:gap-3">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:mt-10 sm:flex-row sm:gap-4">
            ...
            <button
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl border border-slate-600 px-6 py-3.5 text-base font-semibold text-slate-300 transition-all duration-200 hover:border-slate-500 hover:bg-white/5 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950 sm:w-auto sm:px-8 sm:py-4"
            >
              Poznaj nasze usługi
            </button>
          </div>
          ...
          {/* Social Proof Badges */}
          <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-3 sm:mt-14 sm:grid-cols-3 sm:gap-4">
